...
Sea $D$ un conjunto de observaciones, y $X = \{X_1, X_2, \ldots, X_m\}$ el conjunto de variables de interés, entonces definimos la estructura de datos genérica $S$ como un diccionario de Python tal que:
$$S = \{d: \{X_i: x_{d,i} \mid i = 1, 2, \ldots, m\} \mid d \in D\}$$
...
objetivo devolver una diccionario donde cada clave corresponda a una variable numérica y el valor de cada clave 
