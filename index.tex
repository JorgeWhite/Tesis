...
Contexto del proyecto Conductoma y Project42.
...
\textbf{Capítulo 2 Fundamentos matemáticos.}
...
\textbf{Capítulo 3 Modelado matemático de Project42\\
}Naive Bayes.

Construcción de epsilon.

Usando score y epsilon para la construcción de modelos predictivos.

Definición formal del conjunto de datos.

Discretización por cuantiles.

Representación de datos.

Formalización del clasificador.

\textbf{Capítulo 4 Estrategias de optimización}

Complejidad algorítmica.

Análisis teórico de cada enfoque para la recuperación de datos.

Elastic Search vs GraphQL vs Clickhouse

Análisis de complejidad temporal y espacial.

\textbf{Capítulo 5 Resultados experimentales}

Comparación de tiempos de construcción.

Análisis de estabilidad estadística.

Validación empírica de lo teórico.

\textbf{Capítulo 6 Conclusiones}
...
\subsection{2 Estructura de la tesis.}\label{estructura-de-la-tesis.}
...
\subsection{3 Problema matemático y
...
Después se explica a groso modo la idea de Naive Bayes Generalizado,
trabajo desarrollado por el Dr, Stephens que explora qué pasa en un
modelo de Naive Bayes cuando no se supone la independencia de variables.
