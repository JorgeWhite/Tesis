...
En el caso de que $\Omega$ sea el conjunto de los números reales, entonces una sigma-álgebra que nos va a 
ser muy útil es la sigma-álgebra de Borel, que es la sigma-álgebra generada por los intervalos de la forma
${(-\infty, a]}$ con $a \in \mathbb{R}$. De manera más formal, definimos a la sigma-álgebra de Borel, 
denotada por $\mathcal{B}(\mathbb{R})$:

Sea $\Omega = \mathbb{R}$, decimos que $\mathcal{B}(\mathbb{R})$ es la sigma-álgebra de Borel 
...
\begin{definicion}
\textbf{Espacio de Probabilidad Discreto.}  
